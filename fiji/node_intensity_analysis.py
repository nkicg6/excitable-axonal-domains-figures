...
def iter_rois_fwhm(roi_path, img_path, channel, ch_key):
	assert channel == 2 or channel ==3, "Only functions on channel 1 or 2, channel {} given".format(channel)
...
def get_roi_file(nd2_path):
	...
	assert os.path.exists(roi_name), "ROI file {} for {} not found.".format(roi_name, nd2_path)
	return roi_name

#### main run ####
# CONSTANTS
CHANNEL_KEY = {2:"AnkyrinG",
			   3:"Nav1.6",
			   4:"Caspr"}
...
### testing ###
testimg = "/Users/nick/Desktop/node_analysis/blinded/testing_script/testimg.tif"
